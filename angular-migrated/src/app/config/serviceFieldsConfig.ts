...
export const getServiceFields = (serviceType: ServiceType): FieldConfig[] => {
  ...
  const originFields: FieldConfig[] = [
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Calle 10 # 43 - 50',
      required: true,
    },
    {
      name: 'caracteristicas_origen',
      label: 'Características Origen',
      type: 'textarea',
      placeholder: 'Conjunto, torre, apto, quien entrega...',
    },
  ];
  ...
  const destinationFields: FieldConfig[] = [
    ...
    {
      name: 'ciudad_de_destino',
      label: 'Ciudad Destino',
      type: 'text',
      placeholder: 'Ej. Bogotá',
    },
    {
      name: 'direccion_de_destino',
      label: 'Dirección Destino',
      type: 'text',
      placeholder: 'Carrera 7 # 100-20',
    },
    {
      name: 'caracteristicas_destino',
      label: 'Características Destino',
      type: 'textarea',
      placeholder: 'Conjunto, torre, apto, quien recibe...',
    },
  ];
  ...
  const dateTimeFields: FieldConfig[] = [
    {
      name: 'fecha_y_hora_prestacion',
      label: 'Fecha y Hora Prestación',
      type: 'datetime-local',
      required: true,
    },
  ];
  ...
  const evidenceFields: FieldConfig[] = [
    ...
    {
      name: 'cargue_evidencias',
      label: 'Cargue Evidencias Finales',
      type: 'file',
    },
  ];
  ...
  const specialRequirementFields: FieldConfig[] = [
    {
      name: 'requerimiento_especial',
      label: 'Requerimiento Especial',
      type: 'text',
      placeholder: 'Ej: compresor de aire',
    },
  ];
  ...
  const towingFields: FieldConfig[] = [
    {
      name: 'vehiculo_se_encuentra_en_la_via',
      label: '¿Vehículo en la vía?',
      type: 'toggle',
    },
    {
      name: 'vehiculo_esta_en_un_lugar_de_facil_acceso_para_la_grua',
      label: '¿Fácil acceso para grúa?',
      type: 'toggle',
    },
    {
      name: 'vehiculo_presenta_algun_bloqueo_en_la_caja_o_llantas_estan_frenadas',
      label: '¿Bloqueo en caja o llantas?',
      type: 'toggle',
    },
    { name: 'esta_cargado', label: '¿Está cargado?', type: 'toggle' },
    {
      name: 'toneladas_carga',
      label: 'Toneladas de Carga',
      type: 'number',
      placeholder: '0.0',
    },
    {
      name: 'cual_es_el_dano_que_presenta',
      label: '¿Cuál es el daño?',
      type: 'textarea',
  ...
  const heavyVehicleFields: FieldConfig[] = [
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Furgón, estacas, grúa, cisterna...',
    },
  ];

  const rescueFields: FieldConfig[] = [
    {
      name: 'detalles_rescate',
      label: 'Detalles del Rescate',
      type: 'textarea',
      placeholder: 'Tipo de rescate, nivel sótano/piso, bloqueo...',
    },
  ];
  ...
  const electricHybridField: FieldConfig[] = [
    {
      name: 'electrico_hibrido',
      label: 'Eléctrico/Híbrido',
      type: 'select',
      options: ['Ninguno', 'Eléctrico', 'Híbrido'],
    },
  ];
